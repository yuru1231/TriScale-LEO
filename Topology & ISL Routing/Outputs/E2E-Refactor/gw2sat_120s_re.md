...
./ns3 run "test-iridium \
  ...
  --elevMinDeg=5 \
  --enableFeederlink=1 \
  --obsLogPath=Logs/0415_gw2sat_recheck_link_obs.csv \
  --obsInterval=10 \
  --obsDropAlertPct=50" | tee "Topology & ISL Routing/Outputs/E2E-PathType/gw2sat_120s_re.md"
```
```
...
[OBS] log opened: Logs/0415_gw2sat_recheck_link_obs.csv
...
------------------------------------------------------------------------------------
Log: Logs/0415_gw2sat_recheck_link_obs.csv
=============================================
