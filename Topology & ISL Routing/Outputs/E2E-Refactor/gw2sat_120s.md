...
./ns3 run "test-iridium \
  ...
  --elevMinDeg=5 \
  --enableFeederlink=1 \
  --obsLogPath=Logs/0415_gw2sat_refactor_link_obs.csv \
  --obsInterval=10 \
  --obsDropAlertPct=50" | tee "Topology & ISL Routing/Outputs/E2E-Refactor/gw2sat_120s.md"
```
```
...
[OBS] log opened: Logs/0415_gw2sat_refactor_link_obs.csv
...
[CHKPT] 120s | ApplyRoutingTable: slot=2 t=120s | apply=2ms recompute=1ms recomputedSrc=16
...
------------------------------------------------------------------------------------
Log: Logs/0415_gw2sat_refactor_link_obs.csv
=============================================
