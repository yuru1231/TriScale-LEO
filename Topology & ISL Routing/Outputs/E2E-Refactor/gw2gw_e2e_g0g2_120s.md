...
./ns3 run "test-iridium \
  ...
  --enableIsl=1 \
  --enableServicelink=1 \
  --obsLogPath=Logs/0415_gw2gw_e2e_refactor_link_obs.csv \
  --obsInterval=10 \
  --obsDropAlertPct=50" | tee "Topology & ISL Routing/Outputs/E2E-Refactor/gw2gw_e2e_g0g2_120s.md" 
  ```
  ```
...
[OBS] log opened: Logs/0415_gw2gw_e2e_refactor_link_obs.csv
...
[OBS] scope: feeder=3 service=0 isl=14
...
[CHKPT] 120s | RecomputeAffectedRoutes: slot=2 recomputed=15/66 wall=0ms
[CHKPT] 120s | ApplyRoutingTable: slot=2 t=120s | apply=0ms recompute=0ms recomputedSrc=15
...
------------------------------------------------------------------------------------
Log: Logs/0415_gw2gw_e2e_refactor_link_obs.csv
=============================================
