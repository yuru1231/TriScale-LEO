...
./ns3 run "test-iridium \
  ...
  --elevMinDeg=5 \
  --enableFeederlink=1 \
  --obsLogPath=Logs/0415_sat2gw_refactor_link_obs.csv \
  --obsInterval=10 \
  --obsDropAlertPct=50" | tee "Topology & ISL Routing/Outputs/E2E-Refactor-0415/sat2gw_120s.md"
```
```
...
[OBS] log opened: Logs/0415_sat2gw_refactor_link_obs.csv
...
------------------------------------------------------------------------------------
Log: Logs/0415_sat2gw_refactor_link_obs.csv
=============================================
