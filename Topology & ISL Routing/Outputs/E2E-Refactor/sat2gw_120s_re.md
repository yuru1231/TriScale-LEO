...
./ns3 run "test-iridium \
  ...
  --elevMinDeg=5 \
  --enableFeederlink=1 \
  --obsLogPath=Logs/0415_sat2gw_recheck_link_obs.csv \
  --obsInterval=10 \
  --obsDropAlertPct=50" | tee "Topology & ISL Routing/Outputs/E2E-Refactor/sat2gw_120s_re.md"
```
```
...
[OBS] log opened: Logs/0415_sat2gw_recheck_link_obs.csv
...
[CASE] sat2gw | gwId=0 | feederlink observation proxy | isl_cost=N/A
...
------------------------------------------------------------------------------------
Log: Logs/0415_sat2gw_recheck_link_obs.csv
=============================================
