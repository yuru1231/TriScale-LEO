...
#
# 比對目的：與 sat2sat_s0s33_120s.md 形成距離維度對比（1-hop vs 8-hop）
# 預期觀察：路徑固定單跳 0->1 / ISL drop 應更低 / Loaded ISL links 應更少
```
...
[CASE] sat2sat | src=0 dst=1

=== Route Report: Full Paths Across Slots ===
time(s)   src   dst   full_path                                   route_cost    slot  
--------------------------------------------------------------------------------------
0         0     1     0->1                                        0.013173      0     
60.000000 0     1     0->1                                        0.013173      1     
120.0000000     1     0->1                                        0.013173      2     
