...
./ns3 run "scratch/test-iridium \
  ...
  --enableServicelink=1" \
  2>&1 | tee "Topology & ISL Routing/Outputs/sat2ut_120s.log"
```
```
...
[CHKPT] 120s | ApplyRoutingTable: slot=2 t=120s | apply=3ms recompute=2ms recomputedSrc=16
