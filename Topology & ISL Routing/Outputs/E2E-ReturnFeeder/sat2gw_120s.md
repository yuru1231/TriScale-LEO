...
./ns3 run "scratch/test-iridium \
  ...
  --enableFeederlink=1" \
  2>&1 | tee "Topology & ISL Routing/Outputs/sat2gw_120s.log"
```
```
...
[OBS] build=2026-04-15-rf-v2 feederSource=gw_return_rx
...
[CHKPT] 0s | PrecomputeGwRoutes: start | gws=1 pairs=0 slots=3
[GwRouting] slot=0 t=0s GW0[TW-Taipei]=2sats
[GwRouting] slot=1 t=60s GW0[TW-Taipei]=1sats
[GwRouting] slot=2 t=120s GW0[TW-Taipei]=1sats
[CHKPT] 0s | PrecomputeGwRoutes: done | wall=0ms

[CASE] sat2gw | gwId=0 | feederlink_dn only | isl_cost=N/A
[OBS] scope: feeder=1 service=0 isl=0
...
[OBS][EVENT] t=70.0s  [feeder] gw0  window_throughput=0 kbps  => POSSIBLE LINK FAILURE
...
[CHKPT] 120.0s | ApplyRoutingTable: slot=2 t=120.0s | apply=1ms recompute=0ms recomputedSrc=16

=== E2E Link Observability Final Summary ===
link                    rx_pkts   rx_bytes     drop_pkts  drop_rate(%)  avg_delay(ms)
------------------------------------------------------------------------------------
feeder:gw0              5148      2779920      0          0.00          0.00
------------------------------------------------------------------------------------
