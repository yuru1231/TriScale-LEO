    ...
    static TypeId tid =
        TypeId("ns3::PointToPointIslChannel")
            ...
            .AddTraceSource(
                ...
                "ISL propagation delay used when scheduling this packet on the channel",
                MakeTraceSourceAccessor(&PointToPointIslChannel::m_propagationDelayTrace),
                "ns3::TracedCallback::PtrPacketNodeNodeTime");
    return tid;
}
                                      ...
                                      Time txTime)
{
    ...
    m_propagationDelayTrace(p, src->GetNode(), dst, delay);
