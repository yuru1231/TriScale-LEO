 ...
 *   L = W = r_footprint × √2
 *
 * Phase 2.1 will replace this with the low-elevation correction:
 *   L = 2·r,  W = 2·r·sin(ε)
 *
 ...
 *
 * This ENU frame is used consistently with OrbitPointToEnuVec3() so that
 ...
 * Only in-footprint cells are processed by GridUpdateStep.
 */
struct RoiGrid
{
 ...
 * back to (row, col) for CSV output and statistics accumulation.
 *
 * @param grid  RoiGrid produced by GenerateRoiGrid.
