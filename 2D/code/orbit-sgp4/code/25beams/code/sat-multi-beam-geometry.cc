...
// ---------------------------------------------------------------------------
// GetEllipticBeamCenters — 25-beam 5×5 elliptic inscribed-rectangle grid
// ---------------------------------------------------------------------------
                       ...
                       const SimConfig& cfg)
{
    ...
    // 5×5 grid in row-major order (row=cross-track, col=along-track)
    // row/col ∈ {-2,-1,0,+1,+2}, centre = index 12
    std::array<Vec3, 25> centers;
    int idx = 0;
