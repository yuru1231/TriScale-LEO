...
struct SimConfig
{
    ...
    int nBeamsX{5};                     // beams in x direction of array (along-track)
    int nBeamsY{5};                     // beams in y direction of array (cross-track)
    int nBeams{25};                     // total beams (5×5 along-track/cross-track grid)
